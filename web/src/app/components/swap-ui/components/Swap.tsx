...
export function ArrowButton() {
  ...
  return (
    <ImportExportRounded
      className={classes.swapToFromButton}
      fontSize="large"
...
export function SwapTokenForm({
  ...
  return (
    <div className={classes.swapTokenFormContainer} style={style}>
      <div className={classes.swapTokenSelectorContainer}>
        <TokenButton mint={mint} onClick={() => setShowTokenDialog(true)} />
        <Typography color="textSecondary" className={classes.balanceContainer}>
...
function TokenButton({
  ...
  return (
    <div onClick={onClick} className={classes.tokenButton}>
...
async function wrapSol(
  ...
  tx.add(
    SystemProgram.createAccount({
      ...
      lamports: await provider.connection.getMinimumBalanceForRentExemption(10),
      space: 165,
